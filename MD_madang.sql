...
INSERT INTO 극장 VALUES (5, '잠실극장', '송파');-- 상영관 데이터 (극장별 2~3개 상영관)
...
INSERT INTO 상영관 VALUES (5, 2, '앤트맨',       10000, 110);-- 고객 데이터 (8명)
...
INSERT INTO 고객 VALUES (8, '장내윤', '서울시 성동구 왕십리동');-- 예약 데이터 (다양한 날짜와 좌석)
...
SELECT * FROM 상영관;
SELECT * FROM 고객;
SELECT * FROM 예약;-- 4개 테이블 전체 조인 확인
SELECT  t.극장이름,
        s.상영관번호,
        s.영화제목,
        s.가격,
